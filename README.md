...
A análise utiliza os **microdados públicos do [INEP](https://www.gov.br/inep/pt-br/acesso-a-informacao/dados-abertos/microdados/enem)** referentes às edições de **2020 a 2023**, com granularidade individual (entre 3,4 e 5,8 milhões de registros por edição). São consideradas as 5 notas do exame (Ciências da Natureza, Ciências Humanas, Linguagens e Códigos, Matemática e Redação); na análise consolidada entre edições adota-se a média simples dessas 5 notas como métrica de desempenho.
